...
#include <cmath>
#include <algorithm>
#import <GridLines/GridLines-Swift.h>
...
- (void)addGridView {
    GridLines *gridView = [GridLines fromXIB];
    [gridView  addToParentWithParentView:self.view];
//    gridView.translatesAutoresizingMaskIntoConstraints = false;
//    [self.view addSubview:gridView];
    
//    NSDictionary<NSString, id> dict = @{"GridView": gridView};
//    [self.view addConstraints:@[NSLayoutConstraint constraintsWithVisualFormat:@"" options:@[] metrics:nil views:<#(nonnull NSDictionary<NSString *,id> *)#>]
}
